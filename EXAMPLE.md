...
Furthermore, you can also Download and Install the Data Transparency (DTL) Lab Demo-Version for a more pleasing user experience. The DTL-Demo-Version works very similar to the example described in this Tutorial but with a more sophisticated GUI and a larger set of test-data as well as the possibility to enter a search query in a text field and use custom parameters.
